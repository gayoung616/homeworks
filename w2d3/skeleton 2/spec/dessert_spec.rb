...
describe Dessert do
  ...
  subject(:dessert) { Dessert.new("dessert", 100, chef)}
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("dessert", "five") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Tucker the Great Baker has made 100 desserts!")
    end
  end
